		...
		<div class="container">
			...
			<div class="rightDiv">
				<div class="comment-form-wrap pt-5">
					<div class="sidebar-box ftco-animate">
						...
						<ul class="categories">
							<li><input type="hidden" id="sessionIdx"
								value="${login.idx}"><a>${login.name} (${login.id})</a></li>
							<li><a>${login.email}</a></li>
							<li><a>오늘의 닉네임 : ${login.nickname}</a></li>
							<li><button class="btn py-3 px-4 btn-primary"
									style="float: right" id="modeBtn" onclick="editForm()">내
									정보 수정</button></li>
						</ul>
					</div>
				</div>
			...
			<div id="popupDiv">
				...
				<table style="width: 100%">
					...
					<tr>
						<td><input type="hidden" value="${login.id}" name="id"
							id="id"><input class="form-control" type="email"
							id="email" value="${login.email}"></td>
					</tr>
					<tr>
						<td>기존 비밀번호</td>
					</tr>
					<tr>
						<td><input class="form-control" type="password" id="pw1"
							name="pw1" required></td>
					</tr>
					<tr>
						<td>새로운 비밀번호</td>
					</tr>
					<tr>
						<td><input class="form-control" type="password" id="pw2"
							name="pw2" required></td>
					</tr>
					<tr>
						<td>비밀번호 다시입력</td>
					</tr>
					<tr>
						<td><input class="form-control" type="password" id="pw3"
							required><span id="pwSpan"></span><input type="checkbox"
							id="pwCheck"></td>
					</tr>
					<tr>
						<td><input type="button" class="btn py-3 px-4 btn-primary"
							id="edit" value="수정하기"></td>
					</tr>
					<tr>
						<td><button class="btn py-3 px-4 btn-primary"
								id="popCloseBtn">취소</button></td>
					</tr>
				</table>
			</div>
				...
				<div class="comment-form-wrap pt-5">
					<div class="sidebar-box ftco-animate">
						...
						<ul class="categories" id="myPlace">
							<li><span>즐겨찾는 장소를 설정해주세요 <a href="#"
									class="btn py-1 px-4 btn-primary">경로 추가</a></span></li>
							<li><span>즐겨찾는 장소를 설정해주세요 <a href="#"
									class="btn py-1 px-4 btn btn-primary">경로 추가</a></span></li>
							<li><span>즐겨찾는 장소를 설정해주세요 <a href="#"
									class="btn py-1 px-4 btn btn-primary">경로 추가</a></span></li>
						</ul>
					</div>
			...
			<div class="rightDiv">
				<div class="comment-form-wrap pt-5">
					<div class="sidebar-box ftco-animate">
						...
						<a href="#" class="btn py-1 px-4 btn btn-primary"
